...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function fn_sharingsearch(searchKeyword) {
		if('${searchLocation}' != ""){
			if('${searchType}' != ""){
				document.listForm.action = "/ShareMySpace/review?searchKeyword="+searchKeyword+"&searchLocation=${searchLocation}&searchType=${searchType}";
				document.listForm.submit();
			}else{
				document.listForm.action = "/ShareMySpace/review?searchKeyword="+searchKeyword+"&searchLocation=${searchLocation}";
				document.listForm.submit();
			}
		}else{
			if('${searchType}' != ""){
				document.listForm.action = "/ShareMySpace/review?searchKeyword="+searchKeyword+"&searchType=${searchType}";
				document.listForm.submit();
			}else{
				document.listForm.action = "/ShareMySpace/review?searchKeyword="+searchKeyword;
				document.listForm.submit();
			}
		}
	}
	function fn_location(){
		if($('#location').val()!="no"){
			if('${searchType}' != ""){
				if('${searchKeyword}' != ""){
					document.listForm.action = "/ShareMySpace/review?searchLocation="+$('#location').val()+"&searchKeyword=${searchKeyword}&searchType=${searchType}";
					document.listForm.submit();
				}else{
					document.listForm.action = "/ShareMySpace/review?searchLocation="+$('#location').val()+"&searchType=${searchType}";
					document.listForm.submit();
				}
			}else{
				if('${searchKeyword}' != ""){
					document.listForm.action = "/ShareMySpace/review?searchLocation="+$('#location').val()+"&searchKeyword=${searchKeyword}";
					document.listForm.submit();
				}else{
		...
		if('${searchLocation}' != ""){
			if('${searchKeyword}' != ""){
				document.listForm.action = "/ShareMySpace/review?searchType="+room+"&searchKeyword=${searchKeyword}&searchLocation=${searchLocation}";
				document.listForm.submit();
			}else{
				document.listForm.action = "/ShareMySpace/review?searchType="+room+"&searchLocation=${searchLocation}";
				document.listForm.submit();
			}
		}else{
			if('${searchKeyword}' != ""){
				document.listForm.action = "/ShareMySpace/review?searchType="+room+"&searchKeyword=${searchKeyword}";
				document.listForm.submit();
			}else{
	...
	document.listForm.action = "/ShareMySpace/review/content?no="+id;
	document.listForm.submit();
	}
	...
	function fn_reg(){
		...
		document.listForm.action="/ShareMySpace/review/regist";
		document.listForm.submit();
	}
</script>
</head>
		...
		<div id="content">
			...
			<div id="board">
                <div id="tbox1">
                    ...
                    <a href="javascript:fn_reg()" class="icon icon-file-alt button">후기 등록하기</a>
